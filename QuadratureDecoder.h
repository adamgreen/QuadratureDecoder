...
class QuadratureDecoder
{
    public:
        ...
        // quadrature decoder that need to be decoded.
        ...
        // Call this method to register a set of quadrature decoder pins to be counted in the background. The maximum
        // number of encoders that can be registered will be limited to 4, the number of state machines per PIO
        // instance.
        //  pinBase - The number of the lowest GPIO pin connected to the quadrature encoder. The other signal wire from
        //            the encoder needs to be connected to the next highest GPIO pin (example: pins 2&3, pin 3&4, etc).
        ...
        // Call this method to get the current count for a quadrature decoder previously registered with the
    ...
    protected:
        ...
        PIO                 m_pio;
        // The maximum quadrature encoders to be counted are limited by number of state machines in the PIO.
